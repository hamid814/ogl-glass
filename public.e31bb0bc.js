...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"../node_modules/ogl/src/math/functions/Vec3Func.js":[function(require,module,exports) {
"use strict";
...
class Camera extends _Transform.Transform {
  constructor(gl, {
    ...
    this.worldPosition = new _Vec.Vec3();
...
class Skin extends _Mesh.Mesh {
  ...
  createBones(rig) {
    ...
    this.root = new _Transform.Transform();

    // Create bones
    this.bones = [];
    if (!rig.bones || !rig.bones.length) return;
    for (let i = 0; i < rig.bones.length; i++) {
      const bone = new _Transform.Transform();
...
class GLTFLoader {
  ...
  static parsePrimitives(gl, primitives, desc, bufferViews, materials, numInstances) {
    return primitives.map(({
      ...
      const geometry = new _Geometry.Geometry(gl);
...
var _vert = _interopRequireDefault(require("./vert.glsl"));
var _frag = _interopRequireDefault(require("./frag.glsl"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var rotateBtn = document.querySelector('#rotate-btn');
var refractBtn = document.querySelector('#refract-btn');
var values = {
  boxSize: new _ogl.Vec3(1, 1, 1),
  refractionPower: 0
};
var state = {
  isRotating: true,
...
var controls = new _ogl.Orbit(camera, {
  target: new _ogl.Vec3(0, 0.7, 0)
});
document.body.appendChild(gl.canvas);
var geometry = new _ogl.Geometry(gl, {
  position: {
    size: 2,
    data: new Float32Array([-1, -1, 3, -1, -1, 3])
  },
...
var program = new _ogl.Program(gl, {
  ...
  uniforms: {
    ...
    camPos: {
      value: new _ogl.Vec3(0, 0, 5)
    },
    resolution: {
      value: new _ogl.Vec2(window.innerWidth, window.innerHeight)
    },
    boxSize: {
...
refractBtn.addEventListener('click', function () {
  if (state.isRefracting) {
    _gsap.default.to(values, {
      duration: 1,
      refractionPower: 1,
      ease: 'power3.out'
    });
...
requestAnimationFrame(update);
},{"gsap":"../node_modules/gsap/index.js","ogl":"../node_modules/ogl/src/index.mjs","./vert.glsl":"vert.glsl","./frag.glsl":"frag.glsl"}],"D:/binaries/node/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["D:/binaries/node/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
