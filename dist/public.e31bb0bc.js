...
var values = {
  boxSize: new _ogl.Vec3(1.5, 0.3, 0.3)
};
...
document.body.appendChild(gl.canvas); // Triangle that covers viewport, with UVs that still span 0 > 1 across viewport
...
function update(t) {
  ...
  controls.update(); // Don't need a camera if camera uniforms aren't required
...
setTimeout(function () {
  _gsap.default.to(values.boxSize, {
    duration: 1,
    x: 1,
    y: 1,
    z: 1
...
},{"gsap":"../node_modules/gsap/index.js","ogl":"../node_modules/ogl/src/index.mjs","./vert.glsl":"vert.glsl","./frag.glsl":"frag.glsl"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "61076" + '/');
